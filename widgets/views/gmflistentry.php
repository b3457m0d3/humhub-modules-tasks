<?php
/**
* This view represents a wall entry of a task list.
*
* @property User $user the user which created this list
* @property GfmTask $gfmtasklist the current task
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<?php $this->beginContent('application.modules_core.wall.views.wallLayout', array('object' => $gmftasklist)); ?>
